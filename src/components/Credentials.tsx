...
const Credentials = () => {
  return (
    <div className="bg-gradient-to-r from-slate-50 to-blue-50 py-16 relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800"></div>
