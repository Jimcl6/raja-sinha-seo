      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <span className="font-montserrat font-bold text-xl md:text-2xl text-yellow-500">
              Raja Sinha
            </span>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#approach" className="text-gray-600 hover:text-yellow-500 transition-colors">Approach</a>
