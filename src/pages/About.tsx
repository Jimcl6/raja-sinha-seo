          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="flex items-center mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-500 to-amber-600 bg-clip-text text-transparent font-montserrat">A Bit About Me — From Language Lover to SEO Guide</h2>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="flex items-center mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-500 to-amber-600 bg-clip-text text-transparent font-montserrat">SEO Is No Longer Just About Rankings — It's About Results</h2>
              </div>
